              ...
              <div className="grid  lg:grid-cols-4 grid-cols-2   mt-12 mb-10  h-fit gap-5 lg:gap-12 justify-center  items-center">
                ...
                <div className=" w-full items-start   ">
                  <div className="container rounded-lg flex flex-col lg:flex-row gap-4 lg:items-start justify-center">
                    ...
                    <div>
                      <h2 className="title-font lg:w-fit flex-1 lg:text-xl font-medium text-center   text-black">
                       BFSI
                      </h2>
                      <div className="flex justify-center">
                        <h1 className="w-full lg:ml-0  h-[2px] bg-orange"></h1>
                ...
                <div className=" w-full items-start  ">
                  <div className=" rounded-lg flex flex-col lg:flex-row gap-4 lg:items-start justify-center">
                    ...
                    <div>
                      <h2 className="title-font lg:w-fit flex-1  text-center font-medium lg:text-xl text-black">
                       Healthcare
                      </h2>
                      <div className="flex justify-center">
                        <h1 className="w-full lg:ml-0  h-[2px] bg-orange"></h1>
                ...
                <div className=" w-full items-start  ">
                  <div className=" rounded-lg flex flex-col lg:flex-row gap-4 lg:items-start justify-center">
                    ...
                    <div>
                      <h2 className="title-font lg:w-fit font-medium flex-1  text-center lg:text-xl text-black">
                       Retail
                      </h2>
                      <div className="flex justify-center">
                        <h1 className="w-full lg:ml-0  h-[2px] bg-orange"></h1>
